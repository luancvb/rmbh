...
{controles}        <button class="btn-txt" id="btn-zerar" type="button">{rotulo_zerar}</button>
    ...
    <details class="msg" id="painel-msg">
      ...
      <div class="msg-corpo">
        ...
        <p class="msg-nota">Se quiser uma sauda&ccedil;&atilde;o autom&aacute;tica, escreva <code>{{saudacao}}</code> no texto: vira
          <strong>bom dia</strong>, <strong>boa tarde</strong> ou <strong>boa noite</strong> conforme a hora do clique.</p>
        <div class="msg-acoes">
...
'''
    ...
    pag += FIM.format(
        rodape="%d filiados de %d cidades, sem repeti&ccedil;&otilde;es, divididos em %d blocos de at&eacute; %d. "
               "As marca&ccedil;&otilde;es ficam salvas apenas no navegador de cada pessoa."
...
''' % (num, n_blocos, ini + 1, fim, num, len(lote))
        ...
        pag += FIM.format(
            rodape="Bloco %d de %d &middot; filiados %d a %d de %d. "
                   "As marca&ccedil;&otilde;es ficam salvas apenas no navegador de quem est&aacute; usando."

...
(function () {
  ...
  var MSG_PADRAO =
    ...
    "No domingo, dia 20/09, vamos fazer um panfletaço na Feira Hippie, em Belo Horizonte, às 11h. " +
    "Você consegue ir? Me responde aqui confirmando presença.";
  ...
  function textoFinal() {
    ...
    return base.replace(/\{saudacao\}/g, saudacao());
  }
  function link(fone) {
  ...
  function atualizarTopo() {
    ...
    if ((el = document.getElementById("tag-saudacao"))) {
      el.hidden = !(txtMsg && txtMsg.value.indexOf("{saudacao}") !== -1);
  ...
  document.addEventListener("visibilitychange", function () {
    if (!document.hidden) atualizarTopo();
  });
